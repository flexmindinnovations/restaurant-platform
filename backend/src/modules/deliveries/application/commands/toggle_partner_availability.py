...
class TogglePartnerAvailabilityCommand:
    partner_id: uuid.UUID
    is_available: bool


class TogglePartnerAvailabilityHandler:
    def __init__(
        self,
    ...
    async def handle(self, command: TogglePartnerAvailabilityCommand) -> None:
        async with self._uow:
            ...
            partner.toggle_availability(command.is_available)
